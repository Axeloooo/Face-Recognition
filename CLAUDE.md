...
A face recognition system built around the **ORL (Olivetti Research Laboratory) face database** — 40 subjects × 10 grayscale PGM images each (92×112 px, 8-bit). The technical specification lives in `docs/Face Recognition.pdf`. This is a Python project (evidenced by `.gitignore`) in early development; source code has not yet been added.

## Dataset

`dataset/` contains the ORL face database organized as:
```
